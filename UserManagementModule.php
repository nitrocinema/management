...
namespace nitrocinema\modules\UserManagement;
...
class UserManagementModule extends \yii\base\Module
{
     ...
     * @var string
     */
    public $registrationFormClass = 'nitrocinema\modules\UserManagement\models\forms\RegistrationForm';
    ...
    public $controllerNamespace = 'nitrocinema\modules\UserManagement\controllers';
    ...
    public static function t($category, $message, $params = [], $language = null)
    {
        if (!isset(Yii::$app->i18n->translations['modules/user-management/*'])) {
            Yii::$app->i18n->translations['modules/user-management/*'] = [
                ...
                'sourceLanguage' => 'en',
                'basePath'       => '@vendor/nitrocinema/module-user-management/messages',
                'fileMap'        => [
